...
# ######################################################################################################################
# ----------------------------------------------------------------------------------------------------------------------
# Author : Sunil Narhe (sunil.narhe@domainnane.com) 
...
echo -e "</table><p><br/><br/> <br />Regards,<br/>Unix Team.<br/>Email: sunil.narhe@domainnane.com</p></body></html>" >> $SCRIPTFOLDER/control_time.html
rm -rf $templog
HTML_EMAIL
